/**
 * SwiftShare Server v9
 * Changes from v8:
 *  - Gallery prank fully removed (endpoint + DB calls)
 *  - maxHttpBufferSize increased 768KB → 1.5MB (headroom for 256KB chunks + framing)
 *  - Admin-only header check on /api/gallery-data removed (endpoint gone)
...
const io = new Server(server, {
  ...
  // 256KB chunks + Socket.IO framing overhead → 1.5MB gives comfortable headroom
